...
var SECTOR_FR = {
  ...
  'Financial Services': 'Services financiers', 'Mining': 'Exploitation minière',
  'Index Fund': 'Fonds indiciel', 'Commodity Fund': 'Fonds de matières premières',
...
function normalizeSector(sector, lang) {
  ...
  var map = {
    ...
    'mining': { ua: 'Гірничодобувна', en: 'Mining' },
    'нерухомість': { ua: 'Нерухомість', en: 'Real Estate' },
    'промисловість': { ua: 'Промисловість', en: 'Industrials' },
    'індексний фонд': { ua: 'Індексний фонд', en: 'Index Fund' },
    'товарний фонд': { ua: 'Товарний фонд', en: 'Commodity Fund' },
